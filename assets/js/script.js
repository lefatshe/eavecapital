...
"use strict";
			...
			function portfolioInit() {
                ...
                $(window).bind('hashchange', function(){
                    ...
                    if (newHash.substr(0,rootLength) == root) {
                        ...
                        $pageWrap.append('<div id="preloader"></div>');console.log(url)
                        $mainContent.load(url, function(xhr, statusText, request){
	...
	rart.googleMap = function(){
		...
		var mapOptions = {
			    zoom: 12,
			    center: new google.maps.LatLng(-26.0032892, 28.1342935),
		...
		var contentString = '<img src="../img/icon/logo.png" alt="" /><br/><h3>We are here</h3>'+
							'';
		...
		var companyPos = new google.maps.LatLng(-26.07716, 28.33596);
